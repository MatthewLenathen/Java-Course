...
public class ClassRosterDaoFileImpl implements ClassRosterDao{
    ...
    private Student unmarshallStudent(String studentAsText) {
        ...
        String[] splitString = studentAsText.split(DELIMITER);

        // Create new student
        Student tempStudent = new Student(splitString[0]);
        tempStudent.setFirstName(splitString[1]);
        tempStudent.setLastName(splitString[2]);
        tempStudent.setCohort(splitString[3]);
